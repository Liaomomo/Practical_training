...
<!-- Sidebar Navigation end-侧边栏导航结束-->
    ...
    <script type="text/javascript">
       ...
       {
    	   //alert("88888");
           var userinfo = "${requestScope.list}";
           var user =  userinfo.split(",")[16].replace("user_token=","");
           console.log(user);
           console.log("666");     
        /*    $.get('http://172.19.136.174:8888/api/zhihu/data?token='+ user).done(function (data) {
                     console.log(data);
          }); */
           ...
           myChart.setOption({
    			...
    			// 异步加载数据
           $.get('http://172.19.136.174:8888/api/zhihu/data',{token:'alexandeng'}).done(function (vbox) {
		        // 填入数据
