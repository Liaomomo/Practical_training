      ...
      <div class="page-contents">
        <div class="page-header">
          <div class="container-fluid">
            ...
            <div>
               <li  class="active" style="list-style: none; display: inline-block;margin-right: 60px;"><a href="../page/chart_7_1.do" style="text-decoration: none;"> <i class="fa fa-bar-chart" ></i>柱状图 </a></li>
                <li style="list-style: none;display: inline-block;margin-right: 60px;"><a href="./chart_7_2.do" style="text-decoration: none;"> <i class="fa fa-bar-chart"></i>饼图</a></li>
